...
return [
	'user_bar' => [
		...
		'register' => '登録',
		'pm' => 'プライベートメッセージ',
		'pm_count' => '[0]{icon_empty}|[*,*]{icon}{new}未読{count}件{/new}',
		'notifications' => 'Notifications',
		'notifications_count' => '[0]{icon_empty}|[*,*]{icon}{new}未読{count}件{/new}',
		// 'user' => 'User Menu',
		// 'staff' => 'Staff Menu',
	...
	'online_user_list' => [
		'online' => '{stats}{count}{/stats}名のユーザーがオンライン:',
		'hidden' => '{stats}{count}{/stats}名のユーザーがオンライン({stats}{hidden}{/stats}名を非表示):',
		'user_separator' => ', ',
